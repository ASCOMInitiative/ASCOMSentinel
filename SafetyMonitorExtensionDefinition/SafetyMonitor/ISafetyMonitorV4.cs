...
namespace SafetyMonitorExtension
{
    ...
    public interface ISafetyMonitorV4 : ISafetyMonitorV3
    {
        ...
        /// <para>See <see href="SafetyEvents.htm" target="_self" >Action Implementation Notes</see> for information on how clients, Alpaca devices and drivers should implement this method.</para>
        /// </remarks>
        ...
        /// </para>
        /// <para>See <a href="SetExternalEvents.htm" target="_self" >Action Implementation Notes</a> for information on how clients, Alpaca devices and drivers should implement this method.</para>
        /// </remarks>
        ...
        /// <param name="safetyEventIdList">An enumerable list of <see cref="SafetyEvent.Id">SafetyEvent.ID</see> strings to be removed from the device's list of external safety events.</param>
        /// <remarks>
        /// <p style="color:red;"><b>This is an optional method and can report a not implemented error.</b></p>
        /// <para>ClearExternalEvents must only remove events from the external events list, it must not remove events generated by the safety monitor itself.</para>
        /// <para>Internally generated events can only be cleared by the safety monitor itself when the unsafe condition has been resolved.</para>
        /// <para>See <see href="ClearExternalEvents.htm" target="_self" >Action Implementation Notes</see> for information on how clients, Alpaca devices and drivers should implement this method.</para>
        /// </remarks>
